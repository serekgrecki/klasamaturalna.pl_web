...
<section id="covermain">
  ...
  <div class="collapse" id="navbarToggleExternalContent">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="materialy-do-pobrania">Materiały do pobrania</a>
      </li>
  ...
  <div class="collapse navbar-collapse hidden-sm-down" id="navbarNav">
    ...
    <li class="nav-item">
      ...
      <div id="text" style="padding:1rem;">
                <center>
                 <H1>ZAPRASZAMY DO POBIERANIA SPORO PŁATNYCH MATERIAŁÓW CAŁKOWICIE ZA DARMO.</H1>
           <h4>
             <br><br>
             <a href="http://viid.me/qkFlOn" target="_blank"><font color="white">LISTA FILMÓW DO MATURY</font></a>
             <br><br>
              <a href="http://viid.me/qkFmhn" target="_blank"><font color="white">JAK OPISAĆ OBRAZ? </font></a>
              <br><br>
              <a href="http://viid.me/qkFESb" target="_blank"><font color="white">MOTYWY</font></a>
               <br><br>
              <a href="http://viid.me/qkFSbN" target="_blank"><font color="white">GRAMATYKA</font></a>
               <br><br>
              <a href="http://viid.me/qkFAtC" target="_blank"><font color="white">EPOKI</font></a>
                <br><br>
              <a href="http://viid.me/qkFUei" target="_blank"><font color="white">ZAGADNIENIA</font></a>
              <br><br>
              <a href="http://viid.me/qkFFe8" target="_blank"><font color="white">BOGURODZICA - OPRACOWANIE</font></a>
          </h4></center>
      </div>

...
<h3>Zapraszamy do wysyłania pytań, które trafiały się wam na egzaminie ustnym z języka polskiego. Pomoże to nam jak najszybciej poznać, opracować i opublikować te pytania dla pozostałych maturzystów!</h3><br><br>
      
      <h3>Zapraszamy rownież osoby chętne do podzielenia się swoimi materiałai autorskimi z maturzystami, warunki współpracy do omówienia w prywatnej rozmowie.</h3><br><br>
      
      <h1>KONTAKT E-MAIL: kontakt@klasamaturalna.pl</h1>
      
      <br>
      </div>
      <footer style="height:80px;margin:1rem;">
